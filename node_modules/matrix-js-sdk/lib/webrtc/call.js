...
exports.MatrixCall = exports.CallErrorCode = exports.CallEvent = exports.CallParty = exports.CallDirection = exports.CallType = exports.CallState = void 0;
...
(function (MediaQueueId) {
  MediaQueueId["RemoteVideo"] = "remote_video";
  MediaQueueId["RemoteAudio"] = "remote_audio";
  MediaQueueId["LocalVideo"] = "local_video";
})(MediaQueueId || (MediaQueueId = {}));
...
class MatrixCall extends _events.EventEmitter {
  ...
  constructor(opts) {
    ...
    (0, _defineProperty2.default)(this, "mediaPromises", void 0);
    ...
    (0, _defineProperty2.default)(this, "gotUserMediaForInvite", async stream => {
      ...
      for (const videoTrack of (this.screenSharingStream || stream).getVideoTracks()) {
        _logger.logger.info("Adding audio track with id " + videoTrack.id);
    ...
    (0, _defineProperty2.default)(this, "onIceConnectionStateChanged", () => {
      ...
      _logger.logger.debug("ICE connection state changed to: " + this.peerConn.iceConnectionState); // ideally we'd consider the call to be connected when we get media but
        ...
        if (this.remoteVideoElement) {
          this.queueMediaOperation(MediaQueueId.RemoteVideo, async () => {
            ...
            try {
              ...
              _logger.logger.error("Failed to play remote video element", e);
            }
          });
        }
      } else {
    ...
    (0, _defineProperty2.default)(this, "onHangupReceived", msg => {
      _logger.logger.debug("Hangup received"); // party ID must match (our chosen partner hanging up the call) or be undefined (we haven't chosen
    ...
    (0, _defineProperty2.default)(this, "onRejectReceived", msg => {
      _logger.logger.debug("Reject received"); // No need to check party_id for reject because if we'd received either
    ...
    (0, _defineProperty2.default)(this, "onAnsweredElsewhere", msg => {
      _logger.logger.debug("Answered elsewhere");
  ...
  queueMediaOperation(queueId, operation) {
...
function createNewMatrixCall(client, roomId, options) {
  ...
  if (typeof window === 'undefined' || typeof document === 'undefined') {
    _logger.logger.error("No window or document object: WebRTC is not supported in this environement");
