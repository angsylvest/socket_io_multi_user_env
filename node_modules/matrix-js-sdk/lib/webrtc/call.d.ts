...
export declare class MatrixCall extends EventEmitter {
     ...
     * @throws If you have not specified a listener for 'error' events.
     */
    placeScreenSharingCall(remoteVideoElement: HTMLVideoElement, localVideoElement: HTMLVideoElement): Promise<void>;
    private queueMediaOperation;
    /**
