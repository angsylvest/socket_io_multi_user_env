...
{ 
    ...
    private async createScene() 
    {
        ...
        // io.sockets.on('connection', function(socket: Socket[]) => void; on: (arg0: string, arg1: { (username: any): void; (username: any): void; (message: any): void; }) => void; username: string; }) {

        //     // trying to save previous chats
        //     const users: { userID: any; username: any; connected: any; messages: any; }[] = [];
        //     const messagesPerUser = new Map();
        //     messageStore.findMessagesForUser(socket.userID).forEach((message: { from: any; to: any; }) => {
        ...
        //     sessionStore.findAllSessions().forEach((session: { userID: any; username: any; connected: any; }) => {
        //     users.push({
